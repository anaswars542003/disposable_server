...
def register():
    ...
    if request.method == 'POST' and 'username' in request.form and 'password' in request.form and 'email' in request.form :
        ...
        if account:
            ...
            cursor.execute('INSERT INTO accounts VALUES (NULL, % s, SHA2(% s,256) , AES_ENCRYPT(% s,% s))', (username, password, email, app.secret_key, ))
...
def generator():
        ...
        tar_id = gen_id['id']
        for_id = '/rapidalias.xyz/'+str(session['id'])+'/Maildir/'
        cursor.execute('INSERT INTO des_aliases VALUES (% s,  % s, 1, % s)',(dis_id,tar_id,for_id))
        mysql.connection.commit()
